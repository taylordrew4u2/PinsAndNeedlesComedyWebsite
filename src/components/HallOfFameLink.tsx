    ...
    <div className={styles.section}>
      <Link href="/hall-of-fame" className={styles.link} aria-label="Visit the Hall of Fame">
        <svg viewBox="0 0 200 200" className={styles.star} aria-hidden="true">
          ...
          <path d="m100 8 23 63 67 2-52 42 18 67-56-39-56 39 18-67L10 73l67-2Z" fill="url(#hall-star-edge)" stroke="#f6df9e" strokeWidth=".7" />
          <path d="m100 8 23 63 67 2-52 42 18 67-56-39-56 39 18-67L10 73l67-2Z" transform="translate(9 9) scale(.91)" fill="url(#hall-star-gold)" stroke="#fff0b3" strokeWidth=".6" />
          <path d="M100 8v26M10 73l25 9M190 73l-25 9M44 182l15-24M156 182l-15-24" stroke="#fff4cc" strokeWidth=".8" opacity=".75" />
          <path d="m100 125 2 4 4 .5-3 3 .7 4-3.7-2-3.7 2 .7-4-3-3 4-.5Z" fill="#674514" />
        </svg>
        <span className={styles.sparkleOne} aria-hidden="true">✦</span>
        <span className={styles.sparkleTwo} aria-hidden="true">✦</span>
        <span className={styles.name}><span className={styles.small}>Hall of</span><br />Fame</span>
      </Link>
    </div>
  );
}
